"""Stub for fact extractor — real file lives in sprint2-task3 worktree. Not committed."""
...
def extract_facts(
    message: str,
    existing_facts: list[dict[str, object]] | None = None,
    case_type_hint: str | None = None,
) -> dict:
    """Stub: returns empty extraction. Real implementation in sprint2-task3."""
