# PLACEHOLDER — Task 2.6 depends on Task 2.1 (entity + migration)
# This stub allows the intake endpoint to import CaseFact.
# Full entity + migration will be added by Task 2.1 implementer.
